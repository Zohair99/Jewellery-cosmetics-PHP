...
<body>
    ...
    <div class="upper-nav primary-bg p-2 px-3 text-center text-break">
        <span>Summer Sale For All Cosmetic items And Free Express Delivery - OFF 50%! <a>Shop Now</a></span>
    </div>
    <!-- upper-nav -->
    <!-- Start NavBar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand fw-bold" href="index.php">A1</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" class="d-flex align-items-center gap-1" href="admin/index.php">
        ...
        <div class="container">
            <div class="categ-header">
                <div class="sub-title">
                    ...
                    <span class="title" style="font-size:35px">Categories</span>
                </div><br>
                <h2 style="font-size:35px">Browse By Category</h2>
            </div>
            <div class="cards">
                <div class="card">
                    <span>
    ...
    <div class="adver">
        <div class="container">
            <div class="cover"  style="padding-top:410px;">
    ...
    <div class="products">
        <div class="container">
            <div class="categ-header">
                <div class="sub-title">
                    <span class="shape"></span>
                    <span class="title" style="font-size:35px">Our Products</span>
                </div><br>
                <h2 style="font-size:35px">Explore Our Products</h2>
            </div>
            <div class="row mb-3">
                <?php
                getProduct(3);
